...
namespace gazebo {
    ...
    void PoseNeckSpeed::Load ( physics::ModelPtr _model, sdf::ElementPtr _sdf ) {
        ...
        std::string elemPan = std::string(_sdf->GetElement(this->modelPan)->Get<std::string>());
        std::string elemTilt = std::string(_sdf->GetElement(this->modelTilt)->Get<std::string>());
...
*/
    ...
    void PoseNeckSpeed::Init () {
        this->neckspeed.joint_pan->SetParam("vel",0, this->neckspeed.motorsdata.panSpeed);
        this->neckspeed.joint_pan->SetParam("fmax",0, this->stiffness);
        
        this->neckspeed.joint_tilt->SetParam("vel",0, this->neckspeed.motorsdata.tiltSpeed);
        this->neckspeed.joint_tilt->SetParam("fmax",0, this->stiffness);
    }
