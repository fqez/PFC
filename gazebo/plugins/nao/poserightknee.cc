...
*/
    ...
    void PoseRightKnee::OnUpdate () {
        ...
        //          ----------MOTORS----------
        this->rightknee.joint_pitch->SetParam("fmax",0, this->stiffness);
	...
	this->error_tilt = this->rightknee.motorsdata.tilt - this->rightknee.encoders.tilt;
        ...
        double pitchSpeed =  20*(this->rightknee.motorsdata.tilt - this->rightknee.encoders.tilt) + 0.1*(this->error_tilt - this->error_tilt_ant);
...
//std::cout << "goal " << this->rightknee.motorsdata.tilt*180/M_PI << std::endl;
//std::cout << "angle " << this->rightknee.joint_pitch->GetAngle(0).Degree() << std::endl;
