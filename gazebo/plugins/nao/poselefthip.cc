...
/*        
    ...
    void PoseLeftHip::OnUpdate () {
        ...
        //          ----------MOTORS----------
        this->lefthip.joint_yaw->SetParam("fmax",0, this->stiffness);
        this->lefthip.joint_pitch->SetParam("fmax",0, this->stiffness);
...
//sstd::cout << "-------------------------------" << std::endl;
    ...
    void* thread_LeftHipICE ( void* v ) {
        ...
        try {
            ...
            std::string EndpointsMotors = prop->getProperty("PoseLeftHipMotors.Endpoints");
            ...
            Ice::ObjectAdapterPtr AdapterMotors =
                    ic->createObjectAdapterWithEndpoints("AdapterLeftHipMotors", EndpointsMotors);
