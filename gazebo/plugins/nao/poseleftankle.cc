...
*/            
	...
	this->error_roll = this->leftankle.motorsdata.roll - this->leftankle.encoders.roll;
        ...
        double pitchSpeed =  20*(this->leftankle.motorsdata.tilt - this->leftankle.encoders.tilt) + 0.1*(this->error_tilt - this->error_tilt_ant);
	...
	double rollSpeed =  20*(this->leftankle.motorsdata.roll - this->leftankle.encoders.roll) + 0.1*(this->error_roll - this->error_roll_ant);
