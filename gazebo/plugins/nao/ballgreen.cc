...
namespace gazebo {
    ...
    void BallGreen::OnUpdate () {
        ...
        //          ----------MOTORS----------
        this->ballgreen.joint_pan->SetParam("fmax",0, this->stiffness);
        this->ballgreen.joint_tilt->SetParam("fmax",0, this->stiffness);
        ...
        this->ballgreen.joint_pan->SetParam("vel",0, panSpeed);
        this->ballgreen.joint_tilt->SetParam("vel",0, tiltSpeed);
...
/*        if (this->ballgreen.motorsdata.pan > 0) {
            if (this->ballgreen.encoders.pan < this->ballgreen.motorsdata.pan) {
                this->ballgreen.joint_pan->SetParam("vel",0, -0.3);
                this->ballgreen.joint_pan->SetParam("fmax",0, this->stiffness);
        ...
        if (this->ballgreen.motorsdata.tilt > 0) {
            if (this->ballgreen.encoders.tilt < this->ballgreen.motorsdata.tilt) {
                this->ballgreen.joint_tilt->SetParam("vel",0, -0.3);
                this->ballgreen.joint_tilt->SetParam("fmax",0, this->stiffness);
