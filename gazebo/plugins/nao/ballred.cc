...
namespace gazebo {
    ...
    void BallRed::OnUpdate () {
        ...
        //          ----------MOTORS----------
        this->ballred.joint_pan->SetParam("fmax",0, this->stiffness);
        this->ballred.joint_tilt->SetParam("fmax",0, this->stiffness);
        ...
        this->ballred.joint_pan->SetParam("vel",0, panSpeed);
        this->ballred.joint_tilt->SetParam("vel",0, tiltSpeed);
